...
public class GZoltarFaultLocalizer2 implements IFaultLocalizer {
	...
	public GZoltarFaultLocalizer2(String gzoltarDataDir) throws IOException {
		...
		for (int i = 1; i < fLines.size(); i++) {
			...
			if (lcNode.getClassName().contains("OrderedTuple"))
				System.out.println("\n\n\nGZoltarFaultLocalizer2测试行51_其中包括OrderedTuple的东西\n\n\n");
			System.out.println("GZoltarFaultLocalizer2测试行52：输出LcNode："+lcNode+" susValue:"+suspValue);
		}
	}
