...
//        System.out.println("105输出这个是否为真："+isRepaired+"——————————node："+node);
//        if (!isRepaired) {
...
//        System.out.println("239输出这个是否为真："+isRepaired+"——————————node："+node);
//        if (!isRepaired) {
//            for (ExpressionInfo e : expressionInfoList) {
...
//        System.out.println("261输出这个是否为真："+isRepaired+"——————————node："+node);
...
//        System.out.println("287输出这个是否为真："+isRepaired+"——————————node："+node);
//        if (!isRepaired) {
...
//        System.out.println("313输出这个是否为真："+isRepaired+"——————————node："+node);
...
//        System.out.println("398输出这个是否为真："+isRepaired+"——————————node："+node);
//        if (!isRepaired) {
//
//            for (ExpressionInfo e : expressionInfoList) {
